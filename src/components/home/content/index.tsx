...
export default function ContentComponent() {
  return (
    <section className="pr-[72px]  gap-x-[16px] gap-y-[16px] grid grid-cols-1 md:grid-cols-3 max-h-[983px]">
        ...
        <ImageComponent containerClassname="" alt="foto" w="w-[400px]" h="h-[351px]" src={"/images/home/home-image-1.png"}/>
        <ImageComponent containerClassname="" alt="foto" w="w-[400px]" h="h-[462px]" src={"/images/home/home-image-2.png"}/>
        ...
        <ImageComponent alt="foto" w="w-[400px]" h="h-[505px]" src={"/images/home/home-image-5.png"}/>
