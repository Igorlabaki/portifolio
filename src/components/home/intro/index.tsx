  ...
  return (
        <div className="relative">
            ...
            <div className='absolute right-0 top-0'>
                <ImageComponent alt="manWalking" w="w-[516px]" h="h-[687px]" src={"/images/manWalking.png"} containerClassname="brightness-125"/>
                <div className="right-[47px] bottom-[251px] flex justify-between items-center w-[120px] h-[105px] absolute">
                    <ImageComponent  alt='leftBox'  w="w-[27px]" h="h-[102px]" src={"/images/left.png"} /> 
                    <ImageComponent  alt='ritghBox'  w="w-[27px]" h="h-[102px]" src={"/images/rigth.png"} /> 
                </div>
            </div>
            <div className='absolute right-0 top-0 z-40'>
                <div className='w-[516px] h-[687px] relative'>
                <Image src={"/images/texture.png"} className='w-full h-full' alt='ritghBox' layout="fill" objectFit={'cover'}/>
                </div>
            </div>
