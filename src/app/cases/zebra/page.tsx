    ...
    <ScrollProgressComponent>
      ...
      className={`relative `} >
        <div className="relative" onMouseOver={() => setbannerAnimation(true)} onMouseOut={() => setbannerAnimation(false)}>
          ...
          <div className={`absolute top-[299px] left-[300px] font-[700] flex flex-col ${helveltica.className}  ${bannerAnimation ? "text-custom-orange" : "text-custom-white"} duration-700 `}>
              <p className="text-[250px] leading-[214px] z-50">SOLVUM</p>
              <p className="text-[250px] leading-[214px] z-50">ZEBRA</p>
          </div>
        ...
        <div className="mt-[190px] ml-[80px] flex flex-col gap-y-[40px] text-[12px] leading-[16px]" >
          <motion.div className="flex gap-x-[20px]">
            <AnimatedVerticalComponent yStart={400}>
              <BlackWhiteAnimation w="w-[610px]" h="h-[410px]" srcBalckWhite="/images/cases/zebra/zebra-case1-pb.png" srcRegular='/images/cases/zebra/zebra-case1-color.png'/>
            ...
            <div className="flex gap-x-[16px] text-[12px] leading-[16px]">
              ...
              <AnimatedVerticalComponent yStart={400} className='relative'>
                <BlackWhiteAnimation srcBalckWhite="/images/cases/zebra/zebra-case2-pb.png" h="h-[587px]"  w="w-[767px]" srcRegular="/images/cases/zebra/zebra-case2-color.png"/>
              </AnimatedVerticalComponent>
            </div>
          </div>
      </motion.div>
